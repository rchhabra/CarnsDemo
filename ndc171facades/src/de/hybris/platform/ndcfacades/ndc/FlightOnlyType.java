...
@XmlSeeAlso({
    de.hybris.platform.ndcfacades.ndc.BaggageChargesRQ.Query.Flight.class,
    de.hybris.platform.ndcfacades.ndc.BaggageAllowanceRQ.Query.Flight.class,
    de.hybris.platform.ndcfacades.ndc.BaggageListRQ.Query.Flight.class
})
