...
@XmlType(name = "OfferType_2", propOrder = {
    "parameters",
    "validatingCarrier",
    "timeLimits",
    "totalPrice",
...
@XmlSeeAlso({
    de.hybris.platform.ndcfacades.ndc.AirShoppingRS.OffersGroup.AirlineOffers.Offer.class,
    de.hybris.platform.ndcfacades.ndc.AirShoppingRS.OffersGroup.AirlineOffers.ALaCarteOffer.class
})
