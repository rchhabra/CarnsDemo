...
@XmlSeeAlso({
    de.hybris.platform.ndcfacades.ndc.ItinReshopRS.Response.Passengers.Group.class,
    de.hybris.platform.ndcfacades.ndc.OrderChangeRQ.Query.Passengers.Group.class
})
