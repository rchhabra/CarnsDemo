...
<c:set var="searchUrl" value="/assisted-service-querying/listCustomers?sort=${fn:escapeXml(searchPageData.pagination.sort)}&customerListUId=${fn:escapeXml(defaultList)}"/>
<c:set var="baseUrl" value="/assisted-service-querying/listCustomers"/>
<c:set var="frowardUrl" value="/my-account/my-bookings"/>
