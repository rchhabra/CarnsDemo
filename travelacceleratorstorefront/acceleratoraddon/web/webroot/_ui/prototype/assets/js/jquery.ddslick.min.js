(function(a) {
    function g(a, b) {
        ...
        if (l.showSelectedHTML) {
            d.html((m.imageSrc ? '<img alt="" class="dd-selected-image' + (l.imagePosition == "right" ? " dd-image-right" : "") + '" src="' + m.imageSrc + '" />' : "") + (m.text ? '<span class="dd-selected-text">' + m.text + "</span>" : "") + (m.description ? '<small class="dd-selected-description dd-desc' + (l.truncateDescription ? " dd-selected-description-truncated" : "") + '" >' + m.description + "</small>" : ""))
        } else d.html(m.text);
        e.val(m.value);
        ...
        if (typeof l.onSelected == "function") {
            ...
            // a.find('.dd-select .dd-selected').focus();  // To focus on the ddslick element, the minute it loads
        }
    }
    ...
    var b = {},
        ...
        d = '<div class="dd-select"><input class="dd-selected-value" type="hidden" name="code" /><a class="dd-selected" tabindex="0"></a><span class="dd-pointer dd-pointer-down"></span></div>',
        ...
        return this.each(function() {
            ...
            if (!f) {
                ...
                a.each(b.data, function(a, c) {
                    ...
                    m.append("<li>" + '<a class="dd-option" tabindex="0">' + (c.value ? ' <input class="dd-option-value" type="hidden" value="' + c.value + '" />' : "") + (c.imageSrc ? ' <img alt="" class="dd-option-image' + (b.imagePosition == "right" ? " dd-image-right" : "") + '" src="' + c.imageSrc + '" />' : "") + (c.text ? ' <span class="dd-option-text">' + c.text + "</span>" : "") + (c.description ? ' <small class="dd-option-description dd-desc">' + c.description + "</small>" : "") + "</a>" + "</li>")
                });
                var n = {
                    settings: b,
                    original: k,
                ...
                c.find(".dd-select").on({
                    ...
                    "keydown" : function(e) {
                        if (e.keyCode == 40 || e.keyCode == 38) {
                            e.preventDefault();
                            h(c);
                            $(".dd-option.dd-option-selected").focus();
                        }
                    }
                });
                // pressing up or down on the suggestions scrolls through them
                $('.dd-option').on('keydown', function (e){
