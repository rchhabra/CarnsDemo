...
<c:set var="searchUrl"
       value="/my-company/organization-management/manage-permissions?sort=${ycommerce:encodeUrl(searchPageData.pagination.sort)}"/>
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="row heading-with-button">
                <div class="col-xs-7 col-sm-8">
                    <h2 class="h2"><spring:theme code="text.company.${action}.title"/></h2>
                </div>
                <div class="col-xs-5 col-sm-4 button-inline">
                    <a href="${createUrl}" class="btn btn-primary btn-block"><spring:theme
            ...
            <c:if test="${empty searchPageData.results}">
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="pagination-bar-results"><spring:theme code="text.company.noentries"/></div>
                    </div>
                </div>
            </c:if>
                        ...
                        <table class="table">
                            <tbody>
                                <tr class="responsive-table-head hidden-xs">
                                    ...
                                    <th><spring:theme code="text.company.${action}.timespan.label"/></th>
                                    <th><spring:theme code="text.company.${action}.value.title"/></th>
                                ...
                                <c:forEach items="${searchPageData.results}" var="result">
                                    ...
                                    <tr class="responsive-table-item">
                                        <td class="responsive-table-cell hidden-sm hidden-md hidden-lg">
                                            <spring:theme code="text.company.column.id.name"/></td>
                                        <td class="responsive-table-cell">
                                            <a href="${viewPermissionDetailsUrl}">${fn:escapeXml(result.code)}</a>
                                        </td>
                                        <td class="responsive-table-cell hidden-sm hidden-md hidden-lg">
                                            <spring:theme code="text.company.column.type"/></td>
                                        <td class="responsive-table-cell">
                                                ${fn:escapeXml(result.b2BPermissionTypeData.name)}
                                        </td>
                                        <td class="responsive-table-cell hidden-sm hidden-md hidden-lg">
                                            <spring:theme code="text.company.column.parentUnit.name"/></td>
                                        <td class="responsive-table-cell">
                                                ${fn:escapeXml(result.unit.uid)}
                                        </td>
                                        <td class="responsive-table-cell hidden-sm hidden-md hidden-lg">
                                            <spring:theme code="text.company.${action}.timespan.label"/></td>
                                        <td class="responsive-table-cell">
                                            <company:permissionTimespan permission="${result}"/>
                                        </td>
                                        <td class="responsive-table-cell hidden-sm hidden-md hidden-lg">
                                            <spring:theme code="text.company.${action}.value.title"/></td>
                                        <td class="responsive-table-cell">
                                            <company:permissionAmount permission="${result}" displayBracketsAroundCurrency="false"/>
                                        </td>
                                        <td class="responsive-table-cell hidden-sm hidden-md hidden-lg">
                                            <spring:theme code="text.company.column.status.name"/></td>
                                        <td class="status">
                                            <c:choose>
