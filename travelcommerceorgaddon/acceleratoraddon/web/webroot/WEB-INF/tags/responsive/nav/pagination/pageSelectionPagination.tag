        ...
        <c:if test="${hasPreviousPage}">
            <li>
                ...
                <ycommerce:testId code="searchResults_previousPage_link">
                    <a href="${previousPageUrl}" rel="prev" aria-label="Previous"><span aria-hidden="true">&#xab;</span></a>
                </ycommerce:testId>
            </li>
        </c:if>
        ...
        <c:if test="${hasNextPage}">
            <li>
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" rel="next" aria-label="Next"><span aria-hidden="true">&#xbb;</span></a>
                </ycommerce:testId>
            </li>
        </c:if>
