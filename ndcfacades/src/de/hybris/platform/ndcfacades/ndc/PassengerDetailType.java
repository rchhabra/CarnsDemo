...
@XmlSeeAlso({
    de.hybris.platform.ndcfacades.ndc.ItinReshopRS.Response.Passengers.Passenger.class,
    de.hybris.platform.ndcfacades.ndc.OrderChangeRQ.Query.Passengers.Passenger.class,
    de.hybris.platform.ndcfacades.ndc.Passenger.class
})
