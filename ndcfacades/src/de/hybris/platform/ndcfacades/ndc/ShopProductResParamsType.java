...
/**
 * Shop Product Response Message Parameters.
 * 
 * <p>Java class for ShopProductResParamsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ShopProductResParamsType">
 *   &lt;complexContent>
...
@XmlType(name = "ShopProductResParamsType", propOrder = {
    "pricing",
    "inventoryGuarantee",
    "group"
})
public class ShopProductResParamsType
    extends MessageParamsBaseType
{

    @XmlElement(name = "Pricing")
    protected ShopProductResParamsType.Pricing pricing;
    @XmlElement(name = "InventoryGuarantee")
    protected InvGuaranteeType inventoryGuarantee;
    @XmlElement(name = "Group")
    protected ShopProductResParamsType.Group group;
     ...
     * @return
     *     possible object is
     *     {@link ShopProductResParamsType.Pricing }
     *     
     */
    public ShopProductResParamsType.Pricing getPricing() {
        return pricing;
    }
     ...
     *     
     */
    public void setPricing(ShopProductResParamsType.Pricing value) {
        this.pricing = value;
    }
     ...
     *  3. This capability may not be supported by all EDIST-enabled systems or may be supported by bilateral agreement only. If supported, the technical implementation of this capability is not dictated by this specification.
     * 
     * @return
     *     possible object is
     ...
     * @return
     *     possible object is
     *     {@link ShopProductResParamsType.Group }
     *     
     */
    public ShopProductResParamsType.Group getGroup() {
        return group;
    }
     ...
     *     
     */
    public void setGroup(ShopProductResParamsType.Group value) {
        this.group = value;
    }
    ...
    public static class Pricing {
        ...
        protected ShopProductResParamsType.Pricing.FeeExemption feeExemption;
         ...
         * @return
         *     possible object is
         *     {@link ShopProductResParamsType.Pricing.FeeExemption }
         *     
         */
        public ShopProductResParamsType.Pricing.FeeExemption getFeeExemption() {
            return feeExemption;
        }
         ...
         *     
         */
        public void setFeeExemption(ShopProductResParamsType.Pricing.FeeExemption value) {
            ...
            extends AssociatedObjectBaseType
        {
            ...
            @XmlElement(name = "Fee")
            protected List<ShopProductResParamsType.Pricing.FeeExemption.Fee> fee;
             ...
             * {@link ShopProductResParamsType.Pricing.FeeExemption.Fee }
             * 
             * 
             */
            public List<ShopProductResParamsType.Pricing.FeeExemption.Fee> getFee() {
                if (fee == null) {
                    fee = new ArrayList<ShopProductResParamsType.Pricing.FeeExemption.Fee>();
                }
                return this.fee;
            }
            ...
            public static class Fee {
                ...
                protected ShopProductResParamsType.Pricing.FeeExemption.Fee.Code code;
                 ...
                 * @return
                 *     possible object is
                 *     {@link ShopProductResParamsType.Pricing.FeeExemption.Fee.Code }
                 *     
                 */
                public ShopProductResParamsType.Pricing.FeeExemption.Fee.Code getCode() {
                    return code;
                }
                 ...
                 *     
                 */
                public void setCode(ShopProductResParamsType.Pricing.FeeExemption.Fee.Code value) {
                    this.code = value;
                }
