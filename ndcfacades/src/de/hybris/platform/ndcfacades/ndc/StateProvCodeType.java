...
@XmlSeeAlso({
    de.hybris.platform.ndcfacades.ndc.StateProvQueryType.StateCodes.StateCode.class,
    de.hybris.platform.ndcfacades.ndc.StateProvProximityType.StateCode.class
})
