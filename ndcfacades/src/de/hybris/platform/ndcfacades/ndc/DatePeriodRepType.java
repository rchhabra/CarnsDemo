...
@XmlSeeAlso({
    de.hybris.platform.ndcfacades.ndc.OrderListRQ.Query.Filters.CancelDateRange.class,
    de.hybris.platform.ndcfacades.ndc.OrderListRQ.Query.Filters.CreateDateRange.class,
    de.hybris.platform.ndcfacades.ndc.OrderListRQ.Query.Filters.TicketDocument.IssueDateRange.class,
    de.hybris.platform.ndcfacades.ndc.OrderListRQ.Query.Filters.TravelDateRange.class,
    de.hybris.platform.ndcfacades.ndc.CouponEffectiveType.EffectiveDatePeriod.class
})
