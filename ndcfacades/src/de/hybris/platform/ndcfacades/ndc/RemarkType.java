...
@XmlSeeAlso({
    ...
    de.hybris.platform.ndcfacades.ndc.PenaltyType.ApplicableFeeRemarks.class,
    de.hybris.platform.ndcfacades.ndc.PenaltyType.Details.Detail.Amounts.Amount.ApplicableFeeRemarks.class
})
