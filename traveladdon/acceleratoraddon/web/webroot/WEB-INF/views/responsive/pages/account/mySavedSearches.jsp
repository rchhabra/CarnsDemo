				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<spring:theme code="text.page.savedsearch.panel.label" arguments="${fn:escapeXml(searchIdx.index+1)}" />
						</h3>
					</div>
								...
								<div class="col-xs-12">
									<div class="col-xs-12 col-sm-6">
										<dl>
											...
											<dd>
												<spring:theme code="text.page.savedsearch.triptype.${fn:escapeXml(savedSearch.tripType)}" />
											</dd>
										</dl>
									</div>
									<div class="col-xs-12 col-sm-6">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="col-xs-12 col-sm-12 col-md-5">
										<dl>
											...
											<c:forEach items="${savedSearch.passengerTypeQuantities}" var="passengerTypeQuantity" varStatus="ptqIdx">
												<dd>
													<spring:theme code="text.page.savedsearch.passengertype.details" arguments="${fn:escapeXml(passengerTypeQuantity.quantity)},${fn:escapeXml(passengerTypeQuantity.passengerType.name)}" />
												</dd>
											</c:forEach>
										</dl>
									</div>
									...
									<div class="form-group col-xs-6 col-sm-6 col-md-3 col-md-offset-1 bottom-align-parent">
										<a class="btn btn-primary btn-block bottom-align" href="${fn:escapeXml(fareFinderUrl)}">
